...
class Command(BaseCommand):
    ...
    def create_pokemon_cards(self):
        ...
        card2 = PokemonCard(name="Charmeleon", rarity="Rare", hp=120, card_type="Fire", attack="Flamethrower",
                            ...
                            weakness="Water", card_number=5, release_date="1996-02-27", evolution_stage="Stage 2",
        ...
        card3 = PokemonCard(name="Mewtwo", rarity="Uncommon", hp=150, card_type="Psychic", attack="Psychic",
                            ...
                            weakness="Dark", card_number=10, release_date="1996-02-27", evolution_stage="Basic",
                            abilities="Pressure")
        card4 = PokemonCard(name="Caterpie", rarity="Common", hp=45, card_type="Grass", attack="Bug Bite",
                            ...
                            weakness="Fire", card_number=44, release_date="1996-02-27", evolution_stage="Basic",
        ...
        card5 = PokemonCard(name="Squirtle", rarity="Rare", hp=40, card_type="Water", attack="Bubble",
                            ...
                            weakness="Grass", card_number=63, release_date="1996-02-27", evolution_stage="Basic",
                            abilities="Torrent")
        card6 = PokemonCard(name="Eevee", rarity="Rare", hp=50, card_type="Normal", attack="Tackle",
                            ...
                            weakness="Fighting", card_number=51, release_date="1996-02-27", evolution_stage="Basic",
        ...
        card7 = PokemonCard(name="Snorlax", rarity="Uncommon", hp=140, card_type="Normal", attack="Body Slam",
                            ...
                            weakness="Fighting", card_number=27, release_date="1996-02-27", evolution_stage="Final",
                            abilities="Thick Fat")
        card8 = PokemonCard(name="Raikou", rarity="Rare", hp=90, card_type="Electric", attack="Thunder Fang",
                            ...
                            weakness="Ground", card_number=243, release_date="1999-11-21", evolution_stage="Basic",
                            abilities="Pressure")
        card9 = PokemonCard(name="Cryogonal", rarity="Rare", hp=80, card_type="Ice", attack="Aurora Beam",
                            ...
                            weakness="Fire", card_number=615, release_date="2010-09-18", evolution_stage="Basic",
                            abilities="Levitate")
        card10 = PokemonCard(name="Pancham", rarity="Uncommon", hp=67, card_type="Fighting", attack="Circle Throw",
                             ...
                             weakness="Fairy", card_number=674, release_date="2013-08-12", evolution_stage="Basic",
        ...
        card11 = PokemonCard(name="Entei", rarity="Rare", hp=115, card_type="Fire", attack="Flame Wheel",
                             ...
                             weakness="Water", card_number=244, release_date="1999-11-21", evolution_stage="Basic",
                             abilities="Pressure")
        card12 = PokemonCard(name="Suicune", rarity="Rare", hp=100, card_type="Water", attack="Hydro Pump",
                             ...
                             weakness="Grass", card_number=245, release_date="1999-11-21", evolution_stage="Final Form",
                             abilities="Pressure")
        ...
        card15 = PokemonCard(name="Jigglypuf", rarity="Rare", hp=115, card_type="Fairy", attack="Disarming Voice",
                             ...
                             weakness="Dark", card_number=39, release_date="1996-02-27", evolution_stage="Basic",
        ...
        card16 = PokemonCard(name="Duskull", rarity="Common", hp=20, card_type="Ghost", attack="Payback",
                             ...
                             weakness="Dark", card_number=355, release_date="2002-11-21", evolution_stage="Basic",
                             abilities="Levitate")
        card17 = PokemonCard(name="Wobbuffet", rarity="Rare", hp=190, card_type="Pyschic", attack="Destiny Bond",
                             ...
                             weakness="Dark", card_number=202, release_date="2002-11-21", evolution_stage="Final Form",
        ...
        card18 = PokemonCard(name="Darkrai", rarity="Rare", hp=70, card_type="Dark", attack="Dark Pulse",
                             ...
                             weakness="Fairy", card_number=491, release_date="2004-11-18", evolution_stage="Final Form",
        ...
        card19 = PokemonCard(name="Totodile", rarity="Common", hp=50, card_type="Water", attack="Water Gun",
                             ...
                             weakness="Grass", card_number=158, release_date="2001-03-19", evolution_stage="Basic",
                             abilities="Torrent")
    ...
    def create_trainers(self):
        ...
        trainer3 = Trainer(name="Giovanni", birthdate="1983-06-01", location="Viridian City",
        ...
        trainer6 = Trainer(name="Steven", birthdate="1974-11-02", location="Ever Grande City",
                           email="stevenstone@pokemon.com")
        trainer7 = Trainer(name="Roxanne", birthdate="2005-07-02", location="Rustboro City",
        ...
        trainer9 = Trainer(name="Misty", birthdate="1990-06-25", location="Cerulean City", email="misty@pokemon.com")
        trainer10 = Trainer(name="Brock", birthdate="1987-09-03", location="Pewter City", email="brock@pokemon.com")
